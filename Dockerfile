...
# docker build -t cat_hotwire_tutorial .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name cat_hotwire_tutorial cat_hotwire_tutorial
